...
from evaluate_2 import Evaluator
import config
...
def test(args):
    ...
    checkpoint_source_dir = args.checkpoint_source_dir
    ...
    #    'project_eval_data_'+ str(split_id) +'.h5')
    ...
    import shutil
    shutil.copyfile(checkpoint_source_dir +'/' + checkpoint_file_name, checkpoints_dir +'/'+ checkpoint_file_name)    
    ...
    checkpoint = torch.load(checkpoints_dir +'/'+ checkpoint_file_name)
...
if __name__ == '__main__':
    ...
    parser_train.add_argument('--early_stop', type=int, default=200000)
    parser_train.add_argument('--cuda', action='store_true', default=False)

    parser_test = subparsers.add_parser('test')
    parser_test.add_argument('--workspace', type=str, required=True)
    #parser_test.add_argument('--data_type', type=str, default='full_train', choices=['balanced_train', 'full_train'])
    parser_test.add_argument('--sample_rate', type=int, default=32000)
    parser_test.add_argument('--window_size', type=int, default=1024)
    parser_test.add_argument('--hop_size', type=int, default=320)
    parser_test.add_argument('--mel_bins', type=int, default=64)
    parser_test.add_argument('--fmin', type=int, default=50)
    parser_test.add_argument('--fmax', type=int, default=14000)
    parser_test.add_argument('--model_type', type=str, required=True)
    parser_test.add_argument('--freeze_base', type=bool, default=False)
    parser_test.add_argument('--loss_type', type=str, default='clip_bce', choices=['clip_bce', 'clip_nll'])
    #parser_test.add_argument('--balanced', type=str, default='balanced', choices=['none', 'balanced', 'alternate'])
    parser_test.add_argument('--augmentation', type=str, default='mixup', choices=['none', 'mixup'])
    parser_test.add_argument('--batch_size', type=int, default=32)
    parser_test.add_argument('--learning_rate', type=float, default=1e-3)
    #parser_test.add_argument('--resume_iteration', type=int, default=0)
    #parser_test.add_argument('--early_stop', type=int, default=200000)
    parser_test.add_argument('--cuda', action='store_true', default=False)

    parser_test.add_argument('--split_id', type=int)
    parser_test.add_argument('--checkpoint_source_dir', type=str)
    parser_test.add_argument('--checkpoint_file_name', type=str)
