...
def audio_tagging(args):
    ...
    classes_num = 9
    labels = ['screaming','crying_sobbing','chatter','motor_vehicle_(road)','emergency_vehicle','siren','explosion','gunshot_gunfire', 'breaking' ,'others']
...
if __name__ == '__main__':
    ...
    parser_at.add_argument('--freeze_base', type=bool, default=False)
    ...
    parser_sed.add_argument('--freeze_base', type=bool, default=False)
